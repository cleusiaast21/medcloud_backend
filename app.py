...
models = {
    ...
    'D_Ataque Cardíaco': joblib.load('./modelsPython/model_D_Ataque Cardíaco.pkl'),
    ...
    'D_Hipertireoidismo': joblib.load('./modelsPython/model_D_Hipertireoidismo.pkl'),
    'D_Hipoglicemia': joblib.load('./modelsPython/model_D_Hipoglicemia.pkl'),
    'D_Hipotiroidismo': joblib.load('./modelsPython/model_D_Hipotiroidismo.pkl'),
    'D_Malária': joblib.load('./modelsPython/model_D_Malária.pkl'),
    'D_Enxaqueca': joblib.load('./modelsPython/model_D_Enxaqueca.pkl'),
    'D_Paralisia (Hemorragia Cerebral)': joblib.load('./modelsPython/model_D_Paralisia (Hemorragia Cerebral).pkl'),
